/**
 * Gmail API Client
 * Handles all interactions with the Gmail API for email communications
 */
...
/**
 * Upsert Gmail account from OAuth tokens
 */
...
/**
 * Get OAuth client for a specific account
 */
